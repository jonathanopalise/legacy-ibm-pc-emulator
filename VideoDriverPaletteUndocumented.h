...
#ifndef __VIDEO_DRIVER_GENERIC_UNDOCUMENTED
#define __VIDEO_DRIVER_GENERIC_UNDOCUMENTED
...
#define GLYPH_HEIGHT_UNDOCUMENTED 8
#define GLYPH_WIDTH_UNDOCUMENTED 8
#define WIDTH_IN_CHARACTERS_UNDOCUMENTED 80
#define HEIGHT_IN_CHARACTERS_UNDOCUMENTED 100
#define NUM_GRADIENTS_UNDOCUMENTED 8
#define NUM_BACKGROUND_COLOURS_UNDOCUMENTED 8
#define NUM_FOREGROUND_COLOURS_UNDOCUMENTED 16
#define MEMORY_SCROLLUP_OFFSET_UNDOCUMENTED ((WIDTH_IN_CHARACTERS_UNDOCUMENTED*HEIGHT_IN_CHARACTERS_UNDOCUMENTED*2)-2)

class CVideoDriverPaletteUndocumented:public CVideoDriverPalette {
private:
	...
	uint16 *oldBuffer;
public:
	CVideoDriverPaletteUndocumented(uint8 *emulatedSourceAbsoluteAddress);
	void convertFromEmulatedToIntermediate();
	virtual ~CVideoDriverPaletteUndocumented();
