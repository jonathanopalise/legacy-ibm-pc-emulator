...
#ifndef __VIDEO_DRIVER_PALETTE_4H
#define __VIDEO_DRIVER_PALETTE_4H
...
#define GLYPH_HEIGHT_4H 8
#define GLYPH_WIDTH_4H 8
#define WIDTH_IN_CHARACTERS_4H 40
#define HEIGHT_IN_CHARACTERS_4H 25
#define NUM_BACKGROUND_COLOURS_4H 8
#define NUM_FOREGROUND_COLOURS_4H 16
#define MEMORY_SCROLLUP_OFFSET_4H ((WIDTH_IN_CHARACTERS_4H*HEIGHT_IN_CHARACTERS_4H)-1)

class CVideoDriverPalette4h:public CVideoDriverPalette {
private:
...
public:
	...
	CVideoDriverPalette4h(uint8 *emulatedSourceAbsoluteAddress);
	...
	virtual ~CVideoDriverPalette4h(); // needs to clean up stuff allocated in constructor
