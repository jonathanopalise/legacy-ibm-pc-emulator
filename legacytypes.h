...
typedef uint8 * ptruint8;
typedef uint16 * ptruint16;
typedef uint32 * ptruint32;

typedef ptruint8 *ptrptruint8;
typedef ptruint16 *ptrptruint16;
typedef ptruint32 *ptrptruint32;

typedef uint16 nativepixel;
