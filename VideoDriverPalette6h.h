...
#ifndef __VIDEO_DRIVER_PALETTE_6H
#define __VIDEO_DRIVER_PALETTE_6H
...
class CVideoDriverPalette6h:public CVideoDriverPalette {
public:
	virtual uint8 getWidthInCharacters();
	virtual uint8 getHeightInCharacters();

	CVideoDriverPalette6h(uint8 *emulatedSourceAbsoluteAddres);
	virtual void convertFromEmulatedToIntermediate();
	virtual ~CVideoDriverPalette6h(); // needs to clean up stuff allocated in constructor
