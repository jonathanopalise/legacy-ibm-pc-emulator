...
#ifndef __VIDEO_DRIVER_GENERIC_1H
#define __VIDEO_DRIVER_GENERIC_1H
...
#define GLYPH_HEIGHT_1H 8
#define GLYPH_WIDTH_1H 8
#define WIDTH_IN_CHARACTERS_1H 40
#define HEIGHT_IN_CHARACTERS_1H 25
#define NUM_BACKGROUND_COLOURS_1H 8
#define NUM_FOREGROUND_COLOURS_1H 16
#define MEMORY_SCROLLUP_OFFSET_1H ((WIDTH_IN_CHARACTERS_1H*HEIGHT_IN_CHARACTERS_1H*2)-2)

class CVideoDriverPalette1h:public CVideoDriverPalette {
private:
	RGB8 *textModeRGBValues;
	uint8 *glyphs;
	uint16 *oldBuffer;

public:
	CVideoDriverPalette1h(uint8 *emulatedSourceAbsoluteAddress);
	void convertFromEmulatedToIntermediate();
	virtual ~CVideoDriverPalette1h();
